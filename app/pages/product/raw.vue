                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                                {{
                                    $t(
                                        `content.productRaw.${product.id}.description`,
                                    )
                                }}
                            </p>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    >
                                        {{
                                            $t(
                                                "content.productRaw.specificationsLabel",
                                            )
                                        }}
                                    </h3>
                                    <dl
                                ...
                                <div>
                                    ...
                                    >
                                        {{
                                            $t(
                                                "content.productRaw.advantagesLabel",
                                            )
                                        }}
                                    </h3>
                                    <ol
                                        class="list-decimal pl-5 space-y-1.5 text-gray-600"
                                    >
                                        <li
                                            v-for="(adv, i) in tm(
